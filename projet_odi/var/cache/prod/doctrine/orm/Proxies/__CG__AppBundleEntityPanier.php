...
class Panier extends \AppBundle\Entity\Panier implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Panier' . "\0" . 'id_panier', '' . "\0" . 'AppBundle\\Entity\\Panier' . "\0" . 'etat_panier', '' . "\0" . 'AppBundle\\Entity\\Panier' . "\0" . 'date_panier', '' . "\0" . 'AppBundle\\Entity\\Panier' . "\0" . 'id_personne'];
        }
    ...
    public function setEtatPanier($etatPanier)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEtatPanier', [$etatPanier]);

        return parent::setEtatPanier($etatPanier);
    }
    ...
    public function getEtatPanier()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEtatPanier', []);

        return parent::getEtatPanier();
    }
    ...
    public function setIdPersonne(\AppBundle\Entity\Personne $idPersonne = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdPersonne', [$idPersonne]);
